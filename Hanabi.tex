...
Since a \K{3} or \K{4} clue is a complement clue, then to save a \M{3} or a \M{4} a \M{S} clue is needed. \M{2} and \M{5} should be saved with a number clue, as usual. After the first card is discarded, this no longer applies, so \M{3} and \M{4} should be saved with a number clue, as usual.
